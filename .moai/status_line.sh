...
if [ -f "/home/alsrb0519/go/bin/moai" ]; then
	exec "/home/alsrb0519/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/home/alsrb0519/.local/bin/moai" ]; then
	exec "/home/alsrb0519/.local/bin/moai" statusline < "$temp_file"
fi
